<template>
  <div>
    <div class="container max-width">
      <div class="main-image-wrapper">
        ...
        <h1 class="intro-text">
          Pension<br />
          <br />
          <small>Über die Familienpension Gletscherblick</small>
        </h1>
    ...
    <div class="container">
      <h2 class="text-center">Spielplatz</h2>
      An alle Kinder: Schaukel, Sandkiste und Rutsche, auf unserem Spielplatz könnt ihr super toben! Eure Eltern parkt ihr am besten auf der Sonnenterrasse. Da haben sie einen schönen Blick in die Landschaft und nerven Euch nicht! Und sie können Euch schon mal eine Schorle zum Durst löschen bestellen. ☺
    </div>

    <div class="container">
      <h2 class="text-center">Streichelzoo</h2>
      Ob Hausgast oder Urlauber einer anderen Unterkunft, in unserem Streichelzoo sind alle herzlich willkommen. Ob große oder kleine Besucher, wir verlangen keinen Eintritt, freuen uns jedoch über eine Futterspende! Kinder können gerne in der Pension einen Futterbecher für die Tiere abholen. Freut Euch auf viele Hasen, Meerschweinchen, Ziegen und auf unsere Hirschkuh „Bambi“.
    </div>
  </div>
</template>

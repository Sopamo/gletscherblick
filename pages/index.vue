<template>
  <div>
    ...
    <section class="container large-up">
      <h2 class="text-center">Wo Sie uns finden</h2>
      ...
      <br />
      Unser Familienbetrieb liegt knapp fünf Gehminuten vom Ortszentrum entfernt auf einem kleinen Hügel ohne öffentlichen Straßenverkehr.<br />
      <br />
      Lediglich Hausgäste und Familienangehörige fahren bis zum Haus. Da wir in unserem Haus maximal zehn Urlaubsfamilien unterbringen können, garantieren wir – selbst Eltern von drei Kindern – familiäre Betreuung von früh bis spät.
    </section>
    <section class="container clearfix large-up">
      <h2 class="text-center">So erreichen Sie uns</h2>
      ...
      <br />
      E-Mail:
      <a href="mailto:gletscherblick@heiligenblut.at">gletscherblick@heiligenblut.at</a>
    </section>
    <section class="container large-up">
      <h2 class="text-center">Wir freuen uns auf Sie</h2>
      <img src="../assets/content/gletscherblick-maria-und-martin.jpg" width="500" alt="Blick von der Sonnenterrasse nach Heiligenblut" class="albumify float-left" />
